        ...
        <>
            ...
            <div className='flex justify-center items-center columns pt-2 sm:pt-8'>
                <div className='prof shadow-2xl'>
                    <img src={sir1} className='sir mb-8 h-64 w-64 ml-4' />
                ...
                <div className='prof shadow-2xl'>
                    <img src={sir2} className='sir mb-8 h-64 w-64 ml-4' />
                    <div className='text align-center text-center'>
                        ...
                        <div className='flex flex-col justify-center items-center'>
                            ...
                            <div className='flex gap-4'>
                                ...
                                <div class="icon flex "><a href="mailto:vishalhshah@bitmesra.ac.in"><IoIosMail /></a></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className='columns'>
                ...
                <div className='flex flex-col align-center justify-center items-center '>
                    <div className='flex align-center justify-center items-center columns'>
                        <div className='prof align-center justify-center items-center shadow-2xl '>
                            <img src={ujjwalS} className='sir mb-8 h-64 w-64 ml-4' />
                            <div className='text align-center text-center'>
